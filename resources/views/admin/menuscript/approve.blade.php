            ...
            <table class="table table-bordered table-striped mt-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.mark-approve.menuscript', $menuscript->id) }}" class="btn btn-sm btn-success" title="approve" onclick="alert('Are you sure to approve!')"><i class="fa fa-check"></i></a>
                            <a href="{{ route('admin.mark-reject.menuscript', $menuscript->id) }}" class="btn btn-sm btn-info" title="reject" onclick="alert('Are you sure to reject!')"><i class="fas fa-times-circle"></i></a>
