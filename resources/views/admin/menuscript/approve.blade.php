            ...
            <table class="table table-bordered table-striped mt-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.mark-approve.menuscript', $menuscript->id) }}" class="btn btn-sm btn-warning" title="approve" onclick="alert('Are you sure to approve!')"><i class="fas fa-user-lock"></i></a>
                            <a href="{{ route('admin.mark-reject.menuscript', $menuscript->id) }}" class="btn btn-sm btn-info" title="approve" onclick="alert('Are you sure to reject!')"><i class="fas fa-times-circle"></i></a>
