            ...
            <table class="table table-bordered table-striped mt-4">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.mark-approve.menuscript', $menuscript->id) }}" class="btn btn-sm btn-warning" title="approve" onclick="alert('Are you sure to approve!')"><i class="fa fa-check"></i></a>
